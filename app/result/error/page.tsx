    ...
    <div className="flex min-h-screen items-center justify-center bg-page px-4 py-10">
      <div className="w-full max-w-xl">
        ...
        <div className="mt-8 flex flex-col items-center rounded-2xl bg-danger-bg px-6 py-14 text-center">
          ...
          <p className="mt-4 font-semibold text-main">Не удалось обработать снимок</p>
          <p className="mt-2 max-w-sm text-sm text-muted">
            Возможно, файл повреждён или недостаточно данных для анализа. Попробуйте другой снимок.
          </p>
        </div>

        <button
          type="button"
          className="mt-6 w-full rounded-xl bg-button py-3.5 text-base font-medium text-button-text"
        >
